module.exports = {
  ...
  web_accessible_resources: [
    {
      ...
      matches: ['<all_urls>'] // Or more specific if known
    }
  ],
  ...
  // CSP will be primarily handled by chrome.manifest.json or generated by build script
  // content_security_policy: {
  //   "extension_pages": "script-src 'self'; object-src 'self'",
  //   "sandbox": "sandbox allow-scripts allow-forms allow-popups allow-modals; script-src 'self' 'unsafe-inline' 'unsafe-eval'; child-src 'self';"
  // }
  // For now, relying on chrome.manifest.json's stricter policy, which we will also update.
}
